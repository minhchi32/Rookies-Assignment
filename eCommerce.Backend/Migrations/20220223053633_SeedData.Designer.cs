...
namespace eCommerce.Backend.Migrations
{
    ...
    [Migration("20220223053633_SeedData")]
            ...
            modelBuilder.Entity("eCommerce.Backend.Models.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 2, 23, 12, 36, 33, 471, DateTimeKind.Local).AddTicks(6868));
            ...
            modelBuilder.Entity("eCommerce.Backend.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 2, 23, 12, 36, 33, 471, DateTimeKind.Local).AddTicks(9998));
            ...
            modelBuilder.Entity("eCommerce.Backend.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 2, 23, 12, 36, 33, 472, DateTimeKind.Local).AddTicks(4713));
            ...
            modelBuilder.Entity("eCommerce.Backend.Models.ProductColor", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 2, 23, 12, 36, 33, 473, DateTimeKind.Local).AddTicks(717));
            ...
            modelBuilder.Entity("eCommerce.Backend.Models.ProductColorImage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 2, 23, 12, 36, 33, 473, DateTimeKind.Local).AddTicks(7354));
            ...
            modelBuilder.Entity("eCommerce.Backend.Models.ProductColorSize", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 2, 23, 12, 36, 33, 473, DateTimeKind.Local).AddTicks(4001));
            ...
            modelBuilder.Entity("eCommerce.Backend.Models.Rate", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 2, 23, 12, 36, 33, 473, DateTimeKind.Local).AddTicks(9420));
            ...
            modelBuilder.Entity("eCommerce.Backend.Models.Slide", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 2, 23, 12, 36, 33, 474, DateTimeKind.Local).AddTicks(3055));
